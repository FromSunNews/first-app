...
import { DEVICE_TYPES, OPERATING_SYSTEMS } from "./data/worker-steps";
      ...
      <div className="flex flex-col gap-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Add a new computing node to your Walnut Network and start earning rewards
          </p>
        </div>
                ...
                {currentStep === 3 && (
                  <div className="grid grid-cols-2 gap-4">
                    {OPERATING_SYSTEMS.map((os: any) => (
                      ...
                      >
                        <div className="text-xl mr-3 text-sidebar-primary">
                          {React.createElement(os.icon)}
                        </div>
